...
VALUES (1, '김민형', '2021000000001', 'M', '19800726', '010-0000-0000', 'aaa@aaa.net');

INSERT INTO Patient ("병원ID", "환자명", "환자등록번호", "성별코드", "생년월일", "휴대전화번호", "이메일")
VALUES (2, '신입생', '2021000000001', 'M', '20030101', '010-1234-1234', 'bbb@aaa.net');

INSERT INTO Patient ("병원ID", "환자명", "환자등록번호", "성별코드", "생년월일", "휴대전화번호", "이메일")
VALUES (3, '복학생', '2021000000001', 'F', '19901112', '010-1111-2222', 'ccc@aaa.net');

INSERT INTO Patient ("병원ID", "환자명", "환자등록번호", "성별코드", "생년월일", "휴대전화번호", "이메일")
VALUES (3, '재학생', '2021000000002', 'F', '19901112', '010-1111-2222', 'ccc@aaa.net');
